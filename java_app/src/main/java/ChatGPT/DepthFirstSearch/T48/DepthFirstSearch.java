package ChatGPT.DepthFirstSearch.T48;
...
public class DepthFirstSearch {
    ...
    public DepthFirstSearch(List<Edge> edges, int n) {
        ...
        for (Edge edge : edges) {
            ...
            adjacencyList.get(edge.dest).add(edge.source); // Assuming it's an undirected graph
        }
    }
    ...
    public void dfs(int startNode, boolean[] discovered) {
        visitedNodes.clear(); // Clear the previously visited nodes

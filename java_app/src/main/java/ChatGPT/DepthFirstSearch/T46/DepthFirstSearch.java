package ChatGPT.DepthFirstSearch.T46;
...
public class DepthFirstSearch {
    ...
    public DepthFirstSearch(List<Edge> edges, int n) {
        ...
        for (Edge edge : edges) {
            ...
            adjacencyList.get(edge.dest).add(edge.source); // For undirected graph
        }
    }
    ...
    public void dfs(int startNode, boolean[] discovered) {
        visitedNodes.clear(); // Clear any previous data in visitedNodes

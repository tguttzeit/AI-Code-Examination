package Copilot.Kruskal.AIGenerated.T5;
...
public class KruskalTest {
    ...
    public void testKruskal1() {
        ...
        assertEquals(8, mst.get(6).weight);
        assertEquals(9, mst.get(7).weight);
        assertEquals(9, mst.get(8).weight);
        assertEquals(11, mst.get(9).weight);
    }
    @Test

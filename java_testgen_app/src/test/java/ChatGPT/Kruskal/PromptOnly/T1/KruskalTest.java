package ChatGPT.Kruskal.PromptOnly.T1;
...
public class KruskalTest {
    ...
    public void testGraph1() {
        ...
        // For example, check the size of the result and individual edges in the MST.
        assertEquals(6, result.size());
        // You may add more specific assertions based on the expected MST.
    }
    ...
    public void testEmptyGraph() {
        ...
        // Add assertions for an empty graph, e.g., the result should also be empty.

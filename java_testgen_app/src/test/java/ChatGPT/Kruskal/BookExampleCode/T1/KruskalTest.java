package ChatGPT.Kruskal.BookExampleCode.T1;
...
public class KruskalTest {
    ...
    public void testKruskalAlgorithmGraph1() {
        ...
        assertEquals(expectedMST.size(), resultMST.size());
        for (int i = 0; i < expectedMST.size(); i++) {
            assertEquals(expectedMST.get(i).toString(), resultMST.get(i).toString());
        }
    }

package ChatGPT.Dijkstra.PromptOnly.T2;
...
public class DijkstraTest {
    ...
    @Test
    public void testFindShortestPathsGraph1() {
        List<Dijkstra.Edge> edges = Arrays.asList(
                new Dijkstra.Edge(0, 1, 1),
                new Dijkstra.Edge(0, 2, 4),
                new Dijkstra.Edge(1, 2, 3),
    ...
    @Test
    public void testFindShortestPathsGraph2() {
        List<Dijkstra.Edge> edges = Arrays.asList(
                new Dijkstra.Edge(0, 1, 1),
                new Dijkstra.Edge(0, 2, 4),
                new Dijkstra.Edge(1, 2, 3),
    ...
    @Test
    public void testFindShortestPathsGraph3() {
        List<Dijkstra.Edge> edges = Arrays.asList(
        ...
        // Since there are no paths from node 0 to other nodes, all values should be null

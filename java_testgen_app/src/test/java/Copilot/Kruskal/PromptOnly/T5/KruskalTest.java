package Copilot.Kruskal.PromptOnly.T5;
...
public class KruskalTest {
    @Test
    public void testRunKruskalAlgorithm() {
        ...
        assertEquals(new Kruskal.Edge(3, 5, 6), mst.get(1));
        assertEquals(new Kruskal.Edge(2, 4, 5), mst.get(2));
        assertEquals(new Kruskal.Edge(4, 1, 7), mst.get(3));
        assertEquals(new Kruskal.Edge(0, 1, 7), mst.get(4));
        assertEquals(new Kruskal.Edge(4, 3, 2), mst.get(5));
    }

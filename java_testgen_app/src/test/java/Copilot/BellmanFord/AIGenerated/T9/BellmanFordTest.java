...
public class BellmanFordTest {
    ...
    public void testBellmanFord1() {
        ...
        assertEquals(1000000000, (int) map.get(1));
        assertEquals(1000000000, (int) map.get(2));
        assertEquals(1000000000, (int) map.get(3));
        assertEquals(1000000000, (int) map.get(4));
    }

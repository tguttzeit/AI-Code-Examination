from py_testgen_app.src.Copilot.Kruskal.PromptOnly.T7.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal1(self):
        ...
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [(0, 3, 5), (2, 4, 5), (3, 5, 6), (0, 1, 7), (1, 4, 7), (4, 3, 8)])
    ...
    def test_kruskal2(self):
        ...
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [(0, 1, -3), (4, 3, 2), (0, 4, 1), (4, 2, 3)])

from py_testgen_app.src.Copilot.BellmanFord.AIGenerated.T10.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_bellman_ford(self):
        self.assertEqual(self.bellmanFord.bellman_ford(1), {1: 0, 2: 3, 3: -1, 4: 2})

    def test_bellman_ford(self):
        self.assertEqual(self.bellmanFord.bellman_ford(2), {2: 0})
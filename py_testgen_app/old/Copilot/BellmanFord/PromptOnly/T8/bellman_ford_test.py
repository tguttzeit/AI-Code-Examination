from py_testgen_app.src.Copilot.BellmanFord.PromptOnly.T8.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_bellman_ford(self):
        ...
        self.assertEqual(self.bellmanFord2.bellman_ford(0), {1: -1, 2: 2, 4: -2})
        self.assertEqual(self.bellmanFord3.bellman_ford(
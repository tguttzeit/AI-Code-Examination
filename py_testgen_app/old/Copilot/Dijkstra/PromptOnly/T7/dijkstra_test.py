from py_testgen_app.src.Copilot.Dijkstra.PromptOnly.T7.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_add_edge2(self):
        ...
        self.assertEqual(self.dijkstra.find_shortest_paths(0), {0: 0, 1: 1, 2: 4, 3: 3, 4: 3})
        self.assertEqual(self.dijkstra.find_shortest_paths(1), {0: 1, 2: 3, 3: 2,
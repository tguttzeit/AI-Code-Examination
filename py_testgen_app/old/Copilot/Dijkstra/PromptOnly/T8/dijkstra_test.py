from py_testgen_app.src.Copilot.Dijkstra.PromptOnly.T8.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_find_shortest_paths_1(self):
        ...
        self.assertEqual(self.dijkstra.find_shortest_paths(3), {0: 3, 1: 2, 2: 5, 4: 3})
    ...
    def test_find_shortest_paths_2(self):
        ...
        self.assertEqual(self.dijkstra.find_shortest_paths(2), {1:
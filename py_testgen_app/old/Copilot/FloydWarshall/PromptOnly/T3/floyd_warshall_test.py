from py_testgen_app.src.Copilot.FloydWarshall.PromptOnly.T3.floyd_warshall import FloydWarshall
...
class FloydWarshallTest(unittest.TestCase):
    def setUp(self):
        ...
        self.floydWarshall3.add_edge(0, 2, 5)
        self.floydWarshall3.add_edge(1,
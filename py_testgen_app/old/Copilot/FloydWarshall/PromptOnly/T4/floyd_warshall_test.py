from py_testgen_app.src.Copilot.FloydWarshall.PromptOnly.T4.floyd_warshall import FloydWarshall
...
class FloydWarshallTest(unittest.TestCase):
    ...
    def test_path(self):
        ...
        self.assertEqual(self.floydWarshall.path(3, 0), [3, 0])
        self.assertEqual(self.floydWarshall
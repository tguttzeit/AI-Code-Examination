...
class FloydWarshallTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        self.assertEqual(self.floydWarshall1.shortest_distance(0, 4), 7)
        self.assertEqual(self.floydWarshall2.shortest_distance(1, 4), float('inf'))

        # Test shortest distance between nodes in the same graph
        self.assertEqual(self.floydWarshall1.shortest_distance(2, 4), 4)
        self.assertEqual(self.floydWarshall2.shortest_distance(2, 3), 4)

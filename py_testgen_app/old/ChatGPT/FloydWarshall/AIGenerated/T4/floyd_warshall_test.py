...
class TestFloydWarshall(unittest.TestCase):
    ...
    def test_shortest_path_graph1(self):
        self.graph1.run()
        self.assertEqual(self.graph1.matrix[0][4], 9)
        self.assertEqual(self.graph1.path(0, 4), [0, 3, 4])

    def test_shortest_path_graph2(self):
        self.graph2.run()
        self.assertEqual(self.graph2.matrix[0][3], float("inf"))
        self.assertEqual(self.graph2.matrix[0][4], 3)
        self.assertEqual(self.graph2.path(0, 4), [0, 2, 4])

    def test_path_not_exists(self):
        self.graph1.run()
        self.assertEqual(self.graph1.matrix[4][0], float("inf"))

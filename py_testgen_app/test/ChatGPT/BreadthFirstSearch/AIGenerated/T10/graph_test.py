from py_testgen_app.src.ChatGPT.BreadthFirstSearch.AIGenerated.T10.graph import Graph
...
class GraphTest(unittest.TestCase):
    ...
    def test_bfs_starting_from_0(self):
        result = self.graph.bfs(0)
        self.assertEqual(result, [0, 1, 2, 3, 4, 5])

    def test_bfs_starting_from_1(self):
        result = self.graph.bfs(1)
        self.assertEqual(result, [1, 0, 3, 2, 4, 5])

    def test_bfs_starting_from_4(self):

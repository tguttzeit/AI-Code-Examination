from py_testgen_app.src.ChatGPT.DepthFirstSearch.PromptOnly.T6.depth_first_search import DepthFirstSearch

import unittest

class DepthFirstSearchTest(unittest.TestCase):
    def setUp(self):
        # Create an instance of the DepthFirstSearch class for testing

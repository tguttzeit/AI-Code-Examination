from py_testgen_app.src.ChatGPT.BellmanFord.AIGenerated.T8.bellman_ford import BellmanFord
...
class TestBellmanFord(unittest.TestCase):
    ...
    def test_graph_3(self):
        self.bellmanFord.add_edge(0, 0, 1)  # Self-loop with weight 1
        self.bellmanFord.add_edge(1, 2, 3)
        self.bellmanFord.add_edge(1, 3, 2)
        self.bellmanFord.add_edge(1, 4, 2)
        self.bellmanFord.add_edge(3, 2, 5)
        ...
        result = self.bellmanFord.bellman_ford(0)
        self.assertEqual(result, {0: 0, 1: 0, 2: float("inf"), 3: float("inf"), 4: float("inf")})

from py_testgen_app.src.ChatGPT.BellmanFord.AIGenerated.T4.bellman_ford import BellmanFord
...
class TestBellmanFord(unittest.TestCase):
    ...
    def setUp(self):
        self.bellmanFord = BellmanFord(5)  # Initialize with 5 vertices for all tests
    ...
    def test_graph_2(self):
        ...
        result = self.bellmanFord.bellman_ford(0)
        self.assertEqual(result, {0: 0, 1: -1, 2: 2, 3: -2, 4: -3})

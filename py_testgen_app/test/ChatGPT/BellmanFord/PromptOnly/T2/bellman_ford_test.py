from py_testgen_app.src.ChatGPT.BellmanFord.PromptOnly.T2.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_graph_1(self):
        ...
        expected_result = {1: -1, 2: 2, 3: -2, 4: 1}
    ...
    def test_graph_2(self):
        ...
        expected_result = {1: -1, 2: 2, 3: -2, 4: -3}
        self.assertEqual(result, expected_result)
    ...
    def test_graph_3(self):
        ...
        expected_result = {1: 0, 2: 5, 3: 5, 4: 5}
        self.assertEqual(result, expected_result)

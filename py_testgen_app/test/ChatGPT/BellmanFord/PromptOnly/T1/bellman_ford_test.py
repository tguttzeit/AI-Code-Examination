from py_testgen_app.src.ChatGPT.BellmanFord.PromptOnly.T1.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_graph_1(self):
        ...
        expected_result = {1: -1, 2: 2, 3: 0, 4: -1}
    ...
    def test_graph_2(self):
        ...
        result = bellmanFord.bellman_ford(0)
        expected_result = {1: -1, 2: 2, 3: 0, 4: -3}
        self.assertEqual(result, expected_result)
    ...
    def test_graph_3(self):
        ...
        result = bellmanFord.bellman_ford(0)
        expected_result = {1: 0, 2: 3, 3: 2, 4: 2}
        self.assertEqual(result, expected_result)

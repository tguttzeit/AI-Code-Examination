from py_testgen_app.src.ChatGPT.Kruskal.PromptOnly.T6.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    def test_graph_1(self):
        ...
        expected_result = [(0, 3, 5), (2, 4, 5), (3, 5, 6), (1, 4, 7), (0, 1, 7), (4, 6, 9)]
    ...
    def test_graph_2(self):
        ...
        expected_result = [(0, 1, -3), (4, 3, 2), (0, 4, 1), (4, 1, 4)]
        self.assertEqual(result, expected_result)

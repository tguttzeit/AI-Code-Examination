from py_testgen_app.src.Copilot.BellmanFord.BookExampleCode.T2.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_bellman_ford(self):
        ...
        self.assertEqual(self.bellmanFord.bellman_ford(4), {1: 2, 2: 5, 3: 3})
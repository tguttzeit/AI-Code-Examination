from py_testgen_app.src.Copilot.BellmanFord.BookExampleCode.T10.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_bellman_ford(self):
        ...
        self.assertEqual(self.bellmanFord.bellman_ford(3), {1: 1, 2: 4, 4: 2})
        self.assertEqual(self.bellmanFord.bellman_ford(4), {1: -3, 2: 2, 3: -1})
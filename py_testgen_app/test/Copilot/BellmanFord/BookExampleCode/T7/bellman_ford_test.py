from py_testgen_app.src.Copilot.BellmanFord.BookExampleCode.T7.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_graph_3(self):
        self.assertEqual(self.bellmanFord.bellman_ford(0), {0: 0, 1: 1, 2: 4, 3: 2, 4: 3})

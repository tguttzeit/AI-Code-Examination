from py_testgen_app.src.Copilot.BellmanFord.PromptOnly.T9.bellman_ford import BellmanFord
...
class BellmanFordTest(unittest.TestCase):
    ...
    def test_graph_2(self):
        ...
        self.bellmanFord.add_edge(3, 1, 1)
        self.bellmanFord.add_edge(4, 3, -3)
        self.assertEqual(self.bellmanFord.bellman_ford(0), {1: -1, 2: 2, 4: -3})
    ...
    def test_graph_3(self):
        ...
        self.bellmanFord.add_edge(3, 2, 5)
        self.bellmanFord.add_edge(4, 3, 3)
        self.assertEqual(self.bellmanFord.bellman_ford(0), {0: 0})
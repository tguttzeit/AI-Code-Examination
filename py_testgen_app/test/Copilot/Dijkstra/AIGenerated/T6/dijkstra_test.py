from py_testgen_app.src.Copilot.Dijkstra.AIGenerated.T6.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_find_shortest_paths(self):
        ...
        self.assertEqual(self.dijkstra.find_shortest_paths(3), {0: 4, 1: 1, 2: 5, 4: 3})
        self.assertEqual(self.dijkstra.find_shortest_paths(4), {0: 4, 1: 1, 2: 5, 3: 3})
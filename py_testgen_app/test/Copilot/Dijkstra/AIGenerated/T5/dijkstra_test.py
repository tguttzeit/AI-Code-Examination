from py_testgen_app.src.Copilot.Dijkstra.AIGenerated.T5.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_find_shortest_paths_with_loop(self):
        self.dijkstra = Dijkstra(5)
        ...
        self.dijkstra.add_edge(3, 2, 5)
        self.dijkstra.add_edge(4, 3, 3)
        self.assertEqual(self.dijkstra.find_shortest_paths(0), {0: 1, 1: 1, 2: 4, 3: 3, 4: 3})
        self.assertEqual(self.dijkstra.find_shortest_paths(1), {0: 1, 2: 3, 3: 2, 4: 2})
        self
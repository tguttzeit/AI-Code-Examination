from py_testgen_app.src.Copilot.Dijkstra.BookExampleCode.T10.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_shortest_paths(self):
        ...
        self.assertEqual(self.dijkstra2.find_shortest_paths(0), {0: 0, 2: 8, 3: 7, 4: 7})
        self.assertEqual(self.dijkstra3.find_shortest_paths(0), {0: 0, 2: 8, 3: 7, 4: 7})

from py_testgen_app.src.Copilot.Dijkstra.BookExampleCode.T2.dijkstra import Dijkstra
...
class DijkstraTest(unittest.TestCase):
    ...
    def test_find_shortest_paths3(self):
        self.assertEqual(self.dijkstra.find_shortest_paths(2), {0: 4, 1: 3, 3: 8, 4: 6})

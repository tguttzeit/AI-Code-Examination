from py_testgen_app.src.Copilot.Kruskal.BookExampleCode.T1.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal2(self):
        ...
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [(0, 1, -3), (4, 3, 2), (4, 2, 3), (0, 4, 1)])

    def test_kruskal3(self):
        self.kruskal = Kruskal(5)
        self.kruskal.add_edge(0, 1, -3)
        self.kruskal.add_edge(0, 4, 1)
        self.kruskal.add_edge(4,6,5)
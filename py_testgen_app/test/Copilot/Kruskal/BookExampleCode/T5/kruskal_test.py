from py_testgen_app.src.Copilot.Kruskal.BookExampleCode.T5.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    def test_kruskal(self):
        ...
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [(0, 1, -3), (4, 1, 4), (4, 3, 2), (2, 4, 3)])
        self.kruskal = Kruskal(5)
        self.kruskal.add_edge(0, 1, -3)
        self.kruskal.add_edge(0, 4, 1)
        self.kruskal.add_edge(4, 1, 4)

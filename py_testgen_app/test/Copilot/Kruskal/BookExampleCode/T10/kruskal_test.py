from py_testgen_app.src.Copilot.Kruskal.BookExampleCode.T10.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal_algorithm(self):
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [(0, 3, 5), (2, 4, 5), (3, 5, 6), (1, 4, 7), (4, 6, 9), (0, 1, 7)])
        self.assertEqual(self.kruskal2.run_kruskal_algorithm(), [(0, 4, 1), (4, 3, 2), (0, 1, -3), (2, 4, 3)])
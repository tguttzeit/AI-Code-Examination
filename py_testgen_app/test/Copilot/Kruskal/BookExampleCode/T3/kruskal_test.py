from py_testgen_app.src.Copilot.Kruskal.BookExampleCode.T3.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal_1(self):
        ...
        self.assertEqual(mst, [(0, 3, 5), (2, 4, 5), (3, 5, 6), (1, 2, 8), (1, 4, 7), (4, 6, 9)])
    ...
    def test_kruskal_2(self):
        ...
        mst = self.kruskal.run_kruskal_algorithm()
        self.assertEqual(mst, [(0, 1, -3), (4, 3, 2), (0, 4, 1), (2, 4, 3)])

    def test_kruskal_3(self):
        self.kruskal.add_edge(0, 1, 10)
        self.kruskal.add_edge(0, 2, 6)
        self.kruskal.add_edge(0, 3, 5)
        self
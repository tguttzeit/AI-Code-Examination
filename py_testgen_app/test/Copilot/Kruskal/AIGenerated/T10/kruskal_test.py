from py_testgen_app.src.Copilot.Kruskal.AIGenerated.T10.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal(self):
        self.assertEqual(self.kruskal.run_kruskal_algorithm(), [[0, 3, 5], [2, 4, 5], [3, 5, 6], [1, 2, 8], [0, 1, 7], [4, 6, 9]])

from py_testgen_app.src.Copilot.Kruskal.PromptOnly.T4.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_kruskal_graph1(self):
        ...
        self.assertListEqual(self.kruskal.run_kruskal_algorithm(), [(0, 3, 5), (2, 4, 5), (3, 5, 6), (1, 2, 8), (1, 4, 7), (4, 6, 9)])
    ...
    def test_kruskal_graph2(self):
        ...
        self.assertListEqual(self.kruskal.run_kruskal_algorithm(), [(0, 1, -3), (4, 3, 2), (0, 4, 1), (2, 4, 3)])

    def test_kruskal_graph3(self):
        self.kruskal.add_edge(0, 1, -3)
        self.kruskal.add_edge(0, 4, 1)
        self.kruskal.add_edge(4, 1, 4)
        self.kruskal.add_edge(2, 1, 0)
from py_testgen_app.src.Copilot.Kruskal.PromptOnly.T10.kruskal import Kruskal
...
class KruskalTest(unittest.TestCase):
    ...
    def test_graph1(self):
        ...
        expected_result = [(0, 3, 5), (2, 4, 5), (3, 5, 6), (1, 2, 8), (1, 4, 7), (4, 6, 9)]
    ...
    def test_graph3(self):
        ...
        self.kruskal.add_edge(2, 3, 3)
        self.kruskal.add_edge(3, 0, 1)
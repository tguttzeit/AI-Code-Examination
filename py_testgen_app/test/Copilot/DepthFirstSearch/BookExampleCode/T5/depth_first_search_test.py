from py_testgen_app.src.Copilot.DepthFirstSearch.BookExampleCode.T5.depth_first_search import DepthFirstSearch
...
class DepthFirstSearchTest(unittest.TestCase):
    ...
    def test_dfs_with_start_node_0(self):
        self.assertEqual(self.depthFirstSearch.dfs(0), [0, 1, 3, 4, 2, 5])
